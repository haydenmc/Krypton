...
$InvWeapon[10] = "Construction Tool";
$InvWeapon[11] = "Nerf Gun";
$InvWeapon[12] = "Nerf Ball Launcher";
$InvWeapon[13] = "Super Chaingun";
$InvWeapon[14] = "Transport gun";
$InvWeapon[15] = "MIS Tool";
$InvWeapon[16] = "Modifier Tool";
$InvWeapon[17] = "Nuke";
$InvWeapon[18] = "Shotfun";
//$InvWeapon[19] = "CCLM";
$InvWeapon[19] = "Anti Air Gun";
//$InvWeapon[21] = "Smoke Grenade";
$InvWeapon[20] = "Tractor Beam";
$InvWeapon[21] = "Krypton Assault Rifle";
$InvWeapon[22] = "Multi Tool";
$InvWeapon[23] = "Krypton Buster Rifle";
$InvWeapon[24] = "Photon Cannon";

$NameToInv["Blaster"] = "Blaster";
$NameToInv["Plasma Rifle"] = "Plasma";
$NameToInv["Chaingun"] = "Chaingun";
$NameToInv["Spinfusor"] = "Disc";
$NameToInv["Multi-Nade"] = "GrenadeLauncher";
...
$NameToInv["MIS Tool"] = "MergeTool";
$NameToInv["Modifier Tool"] = "ModTool";
...
// END AO
$NameToInv["Nuke"] = "Nuke";
$NameToInv["Shotfun"] = "Shotgun";
//$NameToInv["CCLM"] = "ConcGrenadeLauncher";
$NameToInv["Anti Air Gun"] = "MiniAA";
//$NameToInv["Smoke Grenade"] = "SmokeGrenadeLauncher";
$NameToInv["Tractor Beam"] = "TractorGun";
$NameToInv["Krypton Assault Rifle"] = "Assault";
$NameToInv["Multi Tool"] = "MultiTool";
$NameToInv["Krypton Buster Rifle"] = "Buster";
$NameToInv["Photon Cannon"] = "Photon";
...
$InvPack[21] = "Chaingun Turret Barrel";
//$InvPack[22] = "Deployable Decoy Pack";
$InvPack[22] = "Repair Turret";
$InvPack[23] = "Permission Sphere";
$InvPack[24] = "Editor Pack";
$InvPack[25] = "Waypoint Pack";
$InvPack[26] = "Proximity Switch";
...
$NameToInv["Chaingun Turret Barrel"] = "ChaingunBarrelPack";
...
$NameToInv["Door Pack"] = "TdoorDeployable";
$NameToInv["Editor Pack"] = "EditorPackDeployable";
$NameToInv["Waypoint Pack"] = "waypointDeployable";
...
//$NameToInv["Deployable Decoy Pack"] = "DecoyDeployable";
//[most]
...
$NameToInv["Permission Sphere"] = "PermSphereDeployable";
$NameToInv["Proximity Switch"] = "ProximitySwitch";
...
{
if(isObject(%client.player) && $Host::Purebuild == 1) {
%plyr = %client.player;
%plyr.lastWeapon = ( %plyr.getMountedImage($WeaponSlot) == 0 ) ? "" : %plyr.getMountedImage($WeaponSlot).getName().item;
buyFavorites(%client,1);
//   %client.player.use(%client.player.weaponSlot[0]);
   %client.player.use(%client.player.lastWeapon);
            if(%plyr.getMountedImage($WeaponSlot) == 0)
               %plyr.selectWeaponSlot( 0 );
}
   ...
   %armor = getArmorDatablock( %client, $NameToInv[%client.favorites[0]] );
	if (!%client.isAdmin && !%client.isSuperAdmin) {
		if ($Host::Purebuild == 1) {
			if (%client.favorites[0] !$= "Purebuild" && %client.favorites[0] !$= "VIP Armor")
			%client.favorites[0] = "Purebuild";
...
if (%client.favorites[0] !$= "Administrator")
   if (%client.isAdmin)
	%armorList = %armorList TAB "Administrator";

if (%client.favorites[0] !$= "VIP Armor")
   if (%client.viparmorenabled)
	%armorList = %armorList TAB "VIP Armor";
...
%listOverFlow = "";
   if ( strlen( %list ) > 255 ) //Too many weapons?
   {
      %listOverFlow = getSubStr( %list, 255, 512 );
      %list = getSubStr( %list, 0, 255 );
   }

      messageClient( %client, 'SetLineHud', "", %tag, %x + %lineCount, "Weapon Slot " @ %x + 1 @ ": ", %list , weapon, %client.numFavsCount, %listOverFlow );
   }
...
// Initialize the mod hud for deployable configuration. KRYPTON -- Sloik
%client.modhuddone = 0;
Game.InitModHud(%client);
schedule(1000,0,eval,%client @ ".modhuddone = 1;");
}
