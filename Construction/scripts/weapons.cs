...
$WeaponsHudData[25, bitmapName]   = "gui/hud_grenlaunch";
$WeaponsHudData[25, itemDataName] = "ModTool";
...
$WeaponsHudData[26, itemDataName] = "Shotgun";
$WeaponsHudData[26, ammoDataName] = "ShotgunAmmo";
$WeaponsHudData[26, reticle] = "gui/ret_chaingun";
$WeaponsHudData[26, visible] = "false";

//$WeaponsHudData[27, bitmapName]   = "gui/hud_blaster";
//$WeaponsHudData[27, itemDataName] = "ConcGrenadeLauncher";
//$WeaponsHudData[27, ammoDataName] = "ConcGrenadeLauncherAmmo";
//$WeaponsHudData[27, reticle] = "gui/ret_missile";
//$WeaponsHudData[27, visible] = "true";

$WeaponsHudData[27, bitmapName] = "gui/hud_blaster";  //change this to one of the weapon's hud symbols(look at weapons above it for reference)
$WeaponsHudData[27, itemDataName] = "MiniAA";    //Remember to change the numbers correctly
//$WeaponsHudData[28, ammoDataName] = "";  //No ammo, for a Energy Based Gun
$WeaponsHudData[27, reticle] = "gui/ret_missile"; //Change to reticle you want
$WeaponsHudData[27, visible] = "true";     //False on a select few weapons, usually ones the base 'energy' weapons use.

//$WeaponsHudData[29, bitmapName]   = "gui/hud_blaster";
//$WeaponsHudData[29, itemDataName] = "SmokeGrenadeLauncher";
//$WeaponsHudData[29, ammoDataName] = "SmokeGrenadeLauncherAmmo";
//$WeaponsHudData[29, reticle] = "gui/ret_missile";
//$WeaponsHudData[29, visible] = "true";

$WeaponsHudData[28, bitmapName]   = "gui/hud_blaster";
$WeaponsHudData[28, itemDataName] = "Assault";
$WeaponsHudData[28, ammoDataName] = "AssaultAmmo";
$WeaponsHudData[28, reticle] = "gui/ret_missile";
$WeaponsHudData[28, visible] = "true";

$WeaponsHudData[29, bitmapName]   = "gui/hud_blaster";
$WeaponsHudData[29, itemDataName] = "MultiTool";
$WeaponsHudData[29, reticle] = "gui/ret_missile";
$WeaponsHudData[29, visible] = "true";

$WeaponsHudData[30, bitmapName]   = "gui/hud_blaster";
$WeaponsHudData[30, itemDataName] = "Buster";
$WeaponsHudData[30, ammoDataName] = "BusterAmmo";
$WeaponsHudData[30, reticle] = "gui/ret_missile";
$WeaponsHudData[30, visible] = "true";

$WeaponsHudData[31, bitmapName] = "gui/hud_blaster";
$WeaponsHudData[31, itemDataName] = "Photon";
$WeaponsHudData[31, ammoDataName] = "PhotonAmmo";
$WeaponsHudData[31, reticle] = "gui/ret_blaster";
...
$AmmoIncrement[ShotgunAmmo]	    = 10;
$AmmoIncrement[ConcGrenadeLauncherAmmo]	    = 5;
$AmmoIncrement[SmokeGrenadeLauncherAmmo] = 1;
$AmmoIncrement[AssaultAmmo] = 50;
$AmmoIncrement[BusterAmmo] = 4;
$AmmoIncrement[PhotonAmmo] = 4;
...
exec("scripts/Krypton/mergetool.cs");
exec("scripts/Krypton/multitool.cs");
...
exec("scripts/weapons/conclauncher.cs");
exec("scripts/weapons/aagun.cs");
exec("scripts/weapons/smokegrenadeLauncher.cs");
exec("scripts/weapons/assaultrifle.cs");
exec("scripts/weapons/busterrifle.cs");
exec("scripts/weapons/photon_cannon.cs");
