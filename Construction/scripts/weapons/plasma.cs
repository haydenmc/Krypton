...
datablock ParticleData(PlasmaExplosionParticle)
{
   ...
   colors[0]     = "0.0 0.52 1.0 1.0";
   colors[1]     = "0.0 0.52 1.0 0.0";
   sizes[0]      = 0.5;
   sizes[1]      = 2;
};
...
datablock ParticleData(PlasmaMist)
{
   ...
   textureName          = "particleTest";
   colors[0]     = "0.0 0.52 1.0 1.0";
   colors[1]     = "0.0 0.52 1.0 1.0";
   colors[2]     = "0.0 0.52 1.0 1.0";
   sizes[0]      = 0.5;
   sizes[1]      = 0.5;
   sizes[2]      = 0.8;
   times[0]      = 0.0;
...
datablock SplashData(PlasmaSplash)
{
   ...
   colors[0] = "0.0 0.52 1.0 0.0";
   colors[1] = "0.0 0.52 1.0 1.0";
   colors[2] = "0.0 0.52 1.0 0.0";
   colors[3] = "0.0 0.52 1.0 0.0";
   times[0] = 0.0;
   times[1] = 0.4;
   times[2] = 0.8;
   times[3] = 1.0;
...
datablock LinearFlareProjectileData(PlasmaBolt)
{
   ...
   dryVelocity       = 175;			//V2 55.0;	G 55
   wetVelocity       = -1;			//v2 -1;
   velInheritFactor  = 0.4;		//v2 0.3
   fizzleTimeMS      = 667;		//V2 2000;	G 2000
   lifetimeMS        = 2000;		//V2 3000;	G 3000
   explodeOnDeath    = false;
   reflectOnWaterImpactAngle = 0.0;
   explodeOnWaterImpact      = false;	//v2 true;
   deflectionOnWaterImpact   = 0.0;
   fizzleUnderwaterMS        = 1000;	//v2 -1;
