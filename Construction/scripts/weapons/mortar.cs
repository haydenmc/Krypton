...
datablock ShockwaveData(MortarShockwave)
{
   ...
   colors[0] = "1.0 1.0 0.4 0.50";
   colors[1] = "1.0 1.0 0.4 0.25";
   colors[2] = "1.0 1.0 0.4 0.0";
...
datablock ParticleData(MortarExplosionSmoke)
{
   ...
   colors[0]     = "0.9 0.84 0.33 0.0";
   colors[1]     = "0.88 0.85 0.16 0.5";
   colors[2]     = "0.88 0.85 0.16 0.5";
...
datablock ParticleData(MortarSmokeParticle)
{
   ...
   colors[0]     = "1.0 1.0 0.7 0.5";
   colors[1]     = "0.92 0.89 0.0 0.8";
...
datablock GrenadeProjectileData(MortarShot)
{
   ...
   grenadeFriction   = 0.4;
   armingDelayMS     = 1500;		//v2	 was 2000
   muzzleVelocity    = 68.21;		//v2 was 63.
   drag              = 0.01;		//v2 0.1
...
datablock ShapeBaseImageData(MortarImage)
{
   ...
   projectileSpread = 0.003;		//v2 mod, was 0.0, just enough to remove those super-precise long-range waypoint shots
